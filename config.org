...
* OPACITY
A macro for defining custom colors.
...
#+RESULTS:
| :name | Dagligen  | :property | (agenda-group Dagligen)  | :face  | my/osa-item-dagligen  | :order | 1 |
| :name | Veckovis  | :property | (agenda-group Veckovis)  | :face  | my/osa-item-veckovis  | :order | 2 |
| :name | Månadsvis | :property | (agenda-group Månadsvis) | :face  | my/osa-item-manadsvis | :order | 3 |
| :name | Allmänt   | :property | (agenda-group Allmänt)   | :face  | my/osa-item-allmant   | :order | 4 |
| :name | Övrigt    | :anything | t                        | :order | 99                    |        |   |
...
** OX-HUGO
[[https://ox-hugo.scripter.com/][ox-hugo]] is an Org exporter that exports Org to Hugo-compatible markdown.
